...
Our team aggreed to use WSL and MacOS to keep our whole team in a consistent unix environment. We also kept our package.json file up to date with dependencies to ensure that everyone could setup quickly and easily. These decisions were vital for making it fast and easy to deply when we got to that step.
