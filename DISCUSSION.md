...
2. D2L Course Outlines: The syllabus from where we parse information like assignments and test, only works for one class, can't do it in succession for multiple
3. Google Calendar Login: Username and password, via federated authentication, currently only works with whitelisted developer accounts
